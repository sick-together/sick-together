...
function AccountSetttings(props){
    ...
    useEffect(() => {
        // if (newUsername !== props.user.username && newCity !== props.user.city || newState !== props.user.state){
        //     render()
        // }
    }, [props.user])
    ...
    return(
        <Container className={classes.root}>
            <Typography variant='h3' className={classes.accountTitle}>Your Account Settings</Typography>
            <div>
            ...
            <Button variant='contained' color='primary' className={classes.editButton} onClick={handleOpen}>Edit</Button>
            </Container>)
            :
            (<Container className={classes.root}>
          ...
          <MenuItem value={'WY'}>Wyoming</MenuItem>
            ...
            <Button variant='contained' onClick={editInfo} color='primary' className={classes.submitButton}>Submit Changes</Button>
...
export default connect(mapStateToProps, {editUser})(AccountSetttings)