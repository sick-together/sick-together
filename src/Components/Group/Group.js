...
import { getSelectedGroup, getGroupMessages, addMessage } from '../../Redux/groupReducer.js'
                ...
                <Paper className={classes.root}>
                    ...
                    <section className={classes.flex}>
                        <TextField
                            ...
                            margin="normal"
                        />
                        <Button variant="contained" color="primary" className={classes.button} onClick={() => insertMessage(textValue, group_id)}>
                            Send
